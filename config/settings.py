...
PASSWORD_RESET_REQUEST_LIMIT_PER_EMAIL = int(os.getenv("PASSWORD_RESET_REQUEST_LIMIT_PER_EMAIL", "3"))
PASSWORD_RESET_REQUEST_LIMIT_PER_IP = int(os.getenv("PASSWORD_RESET_REQUEST_LIMIT_PER_IP", "10"))
PASSWORD_RESET_VERIFY_LIMIT_PER_IP = int(os.getenv("PASSWORD_RESET_VERIFY_LIMIT_PER_IP", "20"))
PASSWORD_RESET_VERIFY_LIMIT_PER_TOKEN = int(os.getenv("PASSWORD_RESET_VERIFY_LIMIT_PER_TOKEN", "5"))
PASSWORD_RESET_LOOKBACK_MINUTES = int(os.getenv("PASSWORD_RESET_LOOKBACK_MINUTES", "15"))
